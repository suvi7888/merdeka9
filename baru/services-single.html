...
<head>
    ...
    <!-- Page Title -->
    <title> Services-Single - Offshore - Responsive Gas &amp; Oil Industry HTML Template </title>
    ...
    <div class="wrapper">
        ...
        <main class="main">
            ...
            <div class="page-title text-center">
                <h2 class="title"> Services Single </h2>
            ...
            <div class="breadcrumbs">
                <div class="container">
                    ...
                    <i class="fa fa-chevron-right"></i>
                    <span class="child"> Services Single </span>
                </div>
            </div>
                    ...
                    <div class="col-md-9 services-content">
                        ...
                        <section class="services-vision">
                            <div class="row vision">
                                ...
                                <div class="col-sm-6 text-right">
                                    <a href="#" class="hover-effect">
                                        <img src="images/emp.jpg" alt="emp">
                                    </a>
                                </div>
