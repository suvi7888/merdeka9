...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Home 1 \ Metal — A Construction Company Template</title>
    ...
    <div id="page">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <img src="<?php echo base_url('metal'); ?>/img/sections/man.jpg" alt="" /> 
                ...
                <div class="tp-banner-full">
                    <ul>
                        ...
                        data-title="Intro Slide">
                            <img src="<?php echo base_url('metal'); ?>/img/sections/slider/slide5.jpg" alt="" data-bgposition="left center" data-kenburns="on"
                        ...
                        data-delay="7000" data-title="Features Slide">
                            <img src="<?php echo base_url('metal'); ?>/img/sections/slider/slide4.jpg" alt="" data-bgposition="left" data-kenburns="on"
                        ...
                        data-delay="7000" class="slid2" data-title="Video Slide">
                            <img src="<?php echo base_url('metal'); ?>/img/sections/slider/slide3.jpg" alt="" data-bgposition="left center" data-kenburns="on"
                            data-duration="16000" data-ease="Linear.easeNone" data-bgfit="115" data-bgfitend="115"
                            data-bgpositionend="right bottom" />
                            <div class="elements white">
        ...
        <!-- slider -->
        <section id="features" class="page-section transparent slider-block1" data-animation="fadeInUp">
            <div class="container">
        ...
        <section id="who-we-are" class="page-section light-bg border-tb">
            <div class="container who-we-are">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <p>
                            <img src="<?php echo base_url('metal'); ?>/img/sections/about/founder.jpg" alt="" width="400" height="300" />
                        </p>
                        ...
                        malesuada facilisis.Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    </div>
                    <div class="col-md-4">
				...
				<div class="general-section white">
					<div id="mix-container" class="portfolio-grid custom no-item-pad">
						...
						<div class="grids col-xs-12 col-sm-4 col-md-3 mix all commercial">
							<div class="grid">
								<img src="<?php echo base_url('metal'); ?>/img/sections/portfolio/thumb/1.jpg" width="400" height="273" alt="Recent Work"
								class="img-responsive" />
								<div class="figcaption">
								<h4>Healthcare</h4>
								<!-- Image Popup-->
								<a href="<?php echo base_url('metal'); ?>/img/sections/portfolio/1.jpg" data-rel="prettyPhoto[portfolio]">
									<i class="fa fa-search"></i>
								</a> 
						...
						<div class="grids col-xs-12 col-sm-4 col-md-3 mix all commercial healthcare">
							<div class="grid">
								<img src="<?php echo base_url('metal'); ?>/img/sections/portfolio/thumb/2.jpg" width="400" height="273" alt="Recent Work"
								class="img-responsive" />
								<div class="figcaption">
								<h4>Healthcare</h4>
								<!-- Image Popup-->
								<a href="<?php echo base_url('metal'); ?>/img/sections/portfolio/2.jpg" data-rel="prettyPhoto[portfolio]">
									<i class="fa fa-search"></i>
								</a> 
								<a href="portfolio-single.html">
									<i class="fa fa-link"></i>
						...
						<div class="grids col-xs-12 col-sm-4 col-md-3 mix all commercial education">
							<div class="grid">
								<img src="<?php echo base_url('metal'); ?>/img/sections/portfolio/thumb/3.jpg" width="400" height="273" alt="Recent Work"
								class="img-responsive" />
								<div class="figcaption">
								<h4>Education</h4>
								<!-- Image Popup-->
								<a href="<?php echo base_url('metal'); ?>/img/sections/portfolio/3.jpg" data-rel="prettyPhoto[portfolio]">
									<i class="fa fa-search"></i>
								</a> 
								<a href="portfolio-single.html">
									<i class="fa fa-link"></i>
						...
						<div class="grids col-xs-12 col-sm-4 col-md-3 mix all education residential">
							<div class="grid">
								<img src="<?php echo base_url('metal'); ?>/img/sections/portfolio/thumb/4.jpg" width="400" height="273" alt="Recent Work"
								class="img-responsive" />
								<div class="figcaption">
								<h4>Education</h4>
								<!-- Image Popup-->
								<a href="<?php echo base_url('metal'); ?>/img/sections/portfolio/4.jpg" data-rel="prettyPhoto[portfolio]">
									<i class="fa fa-search"></i>
								</a> 
								<a href="portfolio-single.html">
									<i class="fa fa-link"></i>
						...
						<div class="grids col-xs-12 col-sm-4 col-md-3 mix all healthcare commercial">
							<div class="grid">
								<img src="<?php echo base_url('metal'); ?>/img/sections/portfolio/thumb/5.jpg" width="400" height="273" alt="Recent Work"
								class="img-responsive" />
								<div class="figcaption">
								<h4>Healthcare</h4>
								<!-- Image Popup-->
								<a href="<?php echo base_url('metal'); ?>/img/sections/portfolio/5.jpg" data-rel="prettyPhoto[portfolio]">
									<i class="fa fa-search"></i>
								</a> 
								<a href="portfolio-single.html">
									<i class="fa fa-link"></i>
						...
						<div class="grids col-xs-12 col-sm-4 col-md-3 mix all healthcare commercial residential">
							<div class="grid">
								<img src="<?php echo base_url('metal'); ?>/img/sections/portfolio/thumb/6.jpg" width="400" height="273" alt="Recent Work"
								class="img-responsive" />
								<div class="figcaption">
								<h4>Residential</h4>
								<!-- Image Popup-->
								<a href="<?php echo base_url('metal'); ?>/img/sections/portfolio/6.jpg" data-rel="prettyPhoto[portfolio]">
									<i class="fa fa-search"></i>
								</a> 
								<a href="portfolio-single.html">
									<i class="fa fa-link"></i>
						...
						<div class="grids col-xs-12 col-sm-4 col-md-3 mix all commercial healthcare education">
							<div class="grid">
								<img src="<?php echo base_url('metal'); ?>/img/sections/portfolio/thumb/7.jpg" width="400" height="273" alt="Recent Work"
								class="img-responsive" />
								<div class="figcaption">
								<h4>Healthcare</h4>
								<!-- Image Popup-->
								<a href="<?php echo base_url('metal'); ?>/img/sections/portfolio/7.jpg" data-rel="prettyPhoto[portfolio]">
									<i class="fa fa-search"></i>
								</a> 
								<a href="portfolio-single.html">
									<i class="fa fa-link"></i>
						...
						<div class="grids col-xs-12 col-sm-4 col-md-3 mix all commercial residential">
							<div class="grid">
								<img src="<?php echo base_url('metal'); ?>/img/sections/portfolio/thumb/8.jpg" width="400" height="273" alt="Recent Work"
								class="img-responsive" />
								<div class="figcaption">
								<h4>Commercial</h4>
								<!-- Image Popup-->
								<a href="<?php echo base_url('metal'); ?>/img/sections/portfolio/8.jpg" data-rel="prettyPhoto[portfolio]">
									<i class="fa fa-search"></i>
								</a> 
								<a href="portfolio-single.html">
									<i class="fa fa-link"></i>
        ...
        <section id="team" class="page-section">
            <div class="container text-center">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="owl-carousel pagination-1 text-center" data-pagination="true" data-autoplay="true"
                        data-navigation="false" data-items="3">
                            <div class="item">
                                <div class="client-image">
                                    <!-- Image -->
                                    <img class="img-circle" src="<?php echo base_url('metal'); ?>/img/sections/team/1.jpg" width="80" height="80" alt="" />
                                </div>
                            ...
                            <div class="item">
                                <div class="client-image">
                                    <!-- Image -->
                                    <img class="img-circle" src="<?php echo base_url('metal'); ?>/img/sections/team/2.jpg" width="80" height="80" alt="" />
                                </div>
                                <div class="client-details text-center">
                                    <p>The standard chunk of Lorem Ipsum used since the 1500s is
                                    <br />reproduced below for those intereste.</p>
                            ...
                            <div class="item">
                                <div class="client-image">
                                    <!-- Image -->
                                    <img class="img-circle" src="<?php echo base_url('metal'); ?>/img/sections/team/3.jpg" width="80" height="80" alt="" />
                                </div>
                                <div class="client-details text-center">
                                    <p>The standard chunk of Lorem Ipsum used since the 1500s is
                                    <br />reproduced below for those intereste.</p>
                            ...
                            <div class="item">
                                <div class="client-image">
                                    <!-- Image -->
                                    <img class="img-circle" src="<?php echo base_url('metal'); ?>/img/sections/team/4.jpg" width="80" height="80" alt="" />
                                </div>
                                <div class="client-details text-center">
                                    <p>The standard chunk of Lorem Ipsum used since the 1500s is
                                    <br />reproduced below for those intereste.</p>
